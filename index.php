...
<html lang="en">
    <head>
        ...
        <title>Student Transcript Generating System</title>
    ...
    <body>
        ...
        <nav class="navbar navbar-expand-lg navbar-dark bg-dark">
            <div class="container">
                <a class="navbar-brand" href="index.php">Student Transcript Generating System</a>
...
<?php }} ?>
        ...
        <footer class="py-5 bg-dark">
            <div class="container"><p class="m-0 text-center text-white">Copyright &copy; Student Transcript Generating System <?php echo date('Y');?></p></div>
        </footer>
